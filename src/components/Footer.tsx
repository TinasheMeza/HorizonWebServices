      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <h3 className="text-lg sm:text-xl font-bold gradient-text mb-3">Horizon Web Services</h3>
          ...
          {/* Company & Contact - Stacked on mobile, side by side on larger screens */}
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
              {/* Company */}
              <div>
                <h4 className="font-semibold text-gray-900 mb-3 text-sm sm:text-base">Company</h4>
                <ul className="space-y-2">
              ...
              {/* Contact Info */}
              <div>
                <h4 className="font-semibold text-gray-900 mb-3 text-sm sm:text-base">Contact</h4>
            <ul className="space-y-3">
              <li className="flex items-start gap-2 sm:gap-3">
                <Mail className="text-primary mt-0.5 flex-shrink-0" size={18} />
                <a
                  href="mailto:hello@horizonwebservices.co.za"
                  className="text-gray-600 hover:text-primary transition-colors text-sm break-words"
                >
        ...
        <div className="border-t border-gray-200 mt-6 sm:mt-8 pt-4 sm:pt-6 text-center">
          <p className="text-gray-500 text-xs sm:text-sm">&copy; {new Date().getFullYear()} Horizon Web Services. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
